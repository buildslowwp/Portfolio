---
title: 'Orbitevent'
description: 'AI-Powered Event Management Platform with seamless creation, ticketing, and check-in.'
image: '/project/orbitevent.png'
technologies:
  [
    'Next.js',
    'TypeScript',
...
github: 'https://github.com/Pujan Ratanpara/orbitevent'
live: 'https://orbitevent.vercel.app'
timeline: '1 Month'
role: 'Full Stack'
team: 'Solo'
status: 'Completed'
...
challenges:
  [
    'Structured Output from AI Model (Google Gemini)',
    'Dual-Fulfillment Payment Architecture',
    'Secure QR Scanning Verification',
  ]
learnings:
  [
    'Deep integration of LLMs for structured JSON outputs',
    'Building robust, fault-tolerant webhook processing',
    'Implementing secure and fast mobile check-ins with QR',
  ]
isPublished: true
---
