...
export const siteConfig = {
  ...
  description: `Portfolio of ${about.name}, a Software Developer focused on building clean, scalable web and mobile applications with AI integrations.`,
  url: process.env.NEXT_PUBLIC_URL || 'http://localhost:3000',
  ogImage: '/meta/opengraph-image.png',
  author: {
    name: about.name,
    twitter: '@PujanXCode',
    github: 'Pujan Ratanpara',
    linkedin: 'Pujan Ratanpara',
    email: 'jasaniPujan487@gmail.com',
  },
  keywords: [
    'portfolio',
    'developer',
