...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <Card className="group h-full w-full cursor-pointer overflow-hidden border-gray-100 p-0 shadow-none transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-black/5 dark:border-gray-800 dark:hover:shadow-white/5">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between gap-4">
            <Link href={project.projectDetailsPageSlug}>
              <h3 className="font-archivo group-hover:text-primary text-xl leading-tight font-semibold hover:cursor-pointer">
                {project.title}
              </h3>
            </Link>
      ...
      {project.details && (
        <CardFooter className="mt-auto flex flex-wrap items-center justify-between gap-4 p-6 pt-0">
          <div
            className={`flex items-center gap-1.5 rounded-md px-2 py-1 text-xs font-medium whitespace-nowrap ${
              project.isWorking
          ...
          <Link
            ...
            className="text-secondary hover:text-primary flex shrink-0 items-center gap-2 text-sm whitespace-nowrap underline-offset-4 transition-colors hover:underline"
          >
