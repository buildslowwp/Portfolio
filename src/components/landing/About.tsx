    ...
    <Container className="mt-28">
      ...
      <div className="mt-8 flex flex-col gap-4 md:flex-row">
        <Image
          ...
          width={100}
          height={100}
          className="border-secondary size-60 rounded-md border-2 bg-[#A3B3FF] transition-transform duration-300 hover:scale-[1.02] dark:bg-[#FFA1AD]"
        />
        <div className="mt-4">
          <h3 className="font-archivo text-2xl font-bold">{about.name}</h3>
